...
import 'package:rugram_521028/features/home/home_page.dart';
import 'package:rugram_521028/features/profile/profile_page.dart';
import 'package:rugram_521028/features/navigation/main_screen.dart';
        ...
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(
              ...
              builder: (context, state) => UserProfilePage(userId: '60d0fe4f5311236168a109fa',),
            ),
          ],
        ),
      ],
