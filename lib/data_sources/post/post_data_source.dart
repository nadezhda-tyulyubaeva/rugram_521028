...
import 'package:rugram_521028/data_sources/models/post_preview.dart'
    as source_post_preview;
import 'package:rugram_521028/domain/models/list_model.dart';
import 'package:rugram_521028/domain/models/post_create.dart';
...
class PostDataSource {
  ...
  Future<ListModel<PostPreview>> getPostsByUserId({required String id}) async {
    final result = await dio.get(
      '/user/$id/post'
    );
